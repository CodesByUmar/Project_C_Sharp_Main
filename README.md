...
<p> Another LAN chat application, possibly with different features of implementation compared to the previous one. It reinforces understandin of socket programming in a LAN environment </p>
...
A standard Chess Game in C#, emphasizin'
